...
| **HyDE** | 2212.10496 | Hypothetical Document Embeddings. | **Open HyDE Preprocessor:** Pinky's streaming preamble generates hypotheses [FEAT-432]. | [nodes/archive_node.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/archive_node.py) | **0%** |
