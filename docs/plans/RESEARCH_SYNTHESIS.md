...
| **HyDE** | 2212.10496 | Hypothetical Document Embeddings: Bridges short query to dense BKM semantic gap via hypothetical answer generation. | **Open HyDE Preprocessor:** Pinky's open streaming preamble roleplay serves as the hypothesis generator for ChromaDB vectorization [FEAT-432]. | [nodes/archive_node.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/archive_node.py) | **0%** |
...
| :--- | :--- | :--- | :--- | :--- |
| **MAXS** | 2601.12538 | Lookahead hooks to estimate "Value of Information" before tool calls. | [logic/cognitive_hub.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/logic/cognitive_hub.py) | **Planned** |
| **Voxtral** | N/A | Transition from NeMo EarNode to native high-speed Mistral STT. | N/A | **Planned** |
| **vLLM Serving** | N/A | Achieved SOTA serving throughput for the Web Intercom. | [nodes/loader.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/loader.py) | **100%** |
| **3x3 CVT** | N/A | High-Density Resume Indexer. Correlates Focal goals with Artifact evidence. | [field_notes/ai_engine_v2.py](https://github.com/kEnder242/Portfolio_Dev/blob/main/field_notes/ai_engine_v2.py) | **100%** |
| **Agentic-R** | 2601.11888 | Implement in ArchiveMemory for deep technical search. | [nodes/archive_node.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/archive_node.py) | **Active** |
| **KV‑Cache Routing** | 2606.32032 | Adaptive cache sharing across persona swaps. | [nodes/loader.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/loader.py) | **Planned** |
| **Oracle GraphRAG** | N/A | Graph‑based retrieval for structured artifacts. | [nodes/archive_node.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/archive_node.py) | **Planned** |
| **DSpark Speculative Decoding** | N/A | Faster per‑token generation for role‑token switches. | [nodes/loader.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/loader.py) | **Planned** |
| **Semantic Compass (MCompassRAG)** | 2606.26300 | Metadata‑driven semantic navigation of the archive. | [nodes/archive_node.py](https://github.com/kEnder242/HomeLabAI/blob/main/src/nodes/archive_node.py) | **Planned** |
