...
LAB_SYSTEM_PROMPT = (
    ...
    "2. [FEAT-088] TEMPORAL GRAVITY: If the user asks about ANY past events, work history, or experience (e.g. 'What did I do...', 'My past...', 'Early career', 'vintages', 'previous teams'), you MUST set intent=RECALL.\n"
    "   - RECALL is the HIGHEST PRIORITY for historical lookup. Do NOT use STRATEGIC or CASUAL for these queries.\n"
