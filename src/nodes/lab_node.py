...
async def triage_situational_vibe(query: str, turn_density: float = 1.0) -> str:
    ...
    system_override = (
        ...
        "5. If query involves MATH, formulas, or calculations, topic is 'Math' and importance must be >= 0.8.\n"
        "6. If user uses CORRECTIVE language ('No', 'Wrong', 'Actually'), topic is 'Meta' and importance must be 1.0.\n"
        "7. If query is SPECULATIVE ('What if', 'Imagine'), topic is 'Speculative' and intrigue must be >= 0.8.\n"
        "8. Scalar values must be grounded in query complexity.\n"
