...
# [FEAT-437] HyDE Synthesis Prompt: loaded dynamically from
# src/data/hyde_domain_map.json at startup. Non-fatal fallback below ensures
# the module never crashes on a missing/corrupt JSON file.
...
def _load_hyde_synthesis_prompt():
    """[FEAT-437/438] Load HYDE_SYNTHESIS_PROMPT dynamically from career_compass.json.

    Reads the Continuous Burn keyword mesh (FEAT-438) generated by mass_scan.py
    to close the feedback loop between the 18-year archive and HyDE synthesis.
    Non-fatal: falls back to _HYDE_SYNTHESIS_PROMPT_DEFAULT on missing file/error.
    """
    compass_paths = [
