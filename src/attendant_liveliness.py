"""
⚠️ DEPRECATED — LEGACY BOOT MONITOR ONLY
This script is a legacy v1.0 polling monitor from Acme Lab v3.4.
It is NOT an attendant daemon, supervisor, or rolling reset engine.

Modern Lab Architecture:
- Lab Supervisor Service: lab-attendant.service -> src/acme_lab.py (Foyer Router & Ignition Manager)
- Engine State Transitions: HTTP REST API on port 8765 (/wake, /sleep, /status)
